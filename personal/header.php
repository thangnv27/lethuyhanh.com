...
<head>
    ...
    <meta name="author" content="LÊ THÚY HẠNH" />
...
<!--            <div id="st-trigger-effects">
    ...
    <div class="desktop-header">
        ...
        <div class="top-head">
            <div class="container">
                <div class="sologan pull-left">Chào mừng bạn đến với Website!</div>
        ...
        <div class="wrap-header">
            <div class="container">
                <div class="header">
                    ...
                    <div class="support">
                        <span class="hotline"><?php echo get_option('contact_phone') ?></span>
